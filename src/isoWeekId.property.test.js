...
test('property: time of day within the same UTC day never changes the id', async () => {
  await fc.assert(fc.property(utcDateArb, fc.integer({ min: 0, max: 86399999 }), (date, ms) => {
